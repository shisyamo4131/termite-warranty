...
| Warranty service / product (保証サービス) | Required name, required short name of at most six displayed characters after trimming, default warranty period in positive integer whole years, optional notes, active/inactive state |
