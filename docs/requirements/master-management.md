...
- Direct Firestore writes conform to this rule: clients do not submit or read a revision precondition, while Firestore atomically increments diagnostic revision metadata. Firestore Rules enforce enabled-account access, supported shapes, timestamps, revision progression, and property-reference validity. Name-search N-Grams are generated by the shared client/domain mapper under the provisional access posture.
