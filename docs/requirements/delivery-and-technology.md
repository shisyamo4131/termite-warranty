...
- Google Maps Platform Geocoding API is adopted for postal-code address lookup. The integration retains a replaceable provider boundary and manual address entry fallback.
