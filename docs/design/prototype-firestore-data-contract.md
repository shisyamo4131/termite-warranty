...
| `warrantyServices/{serviceId}` | `name: string`, `shortName: nonblank string`, `defaultPeriodYears: positive integer`, `notes: string \| null`, `active: boolean`, `revision: safe positive integer below Number.MAX_SAFE_INTEGER`, `createdAt: Timestamp`, `updatedAt: Timestamp` |
